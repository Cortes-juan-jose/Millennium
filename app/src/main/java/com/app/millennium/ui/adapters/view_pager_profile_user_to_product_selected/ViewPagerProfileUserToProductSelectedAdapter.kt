...
import com.app.millennium.ui.fragments.products_and_opinions_to_user_product_selected.OpinionsUserToProductSelectedFragment
import com.app.millennium.ui.fragments.products_and_opinions_to_user_product_selected.ProductsUserToProductSelectedFragment
...
class ViewPagerProfileUserToProductSelectedAdapter(
    ...
    override fun createFragment(position: Int): Fragment {
        return when(position){
            ...
            1 -> { OpinionsUserToProductSelectedFragment(idUser) }
            else -> { Fragment() }
        }
    }
}