...
import com.app.millennium.ui.fragments.products_and_likes_to_user_product_selected.LikesUserToProductSelectedFragment
...
class ViewPagerProfileUserToProductSelectedAdapter(
    ...
    override fun createFragment(position: Int): Fragment {
        return when(position){
            ...
            1 -> { LikesUserToProductSelectedFragment(idUser) }
            else -> { Fragment() }
        }
    }
}